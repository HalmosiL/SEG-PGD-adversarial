...
def cyclic_learning_rate(optimizer, n_repeats, i, j, base_lr, max_iter):
    """Sets the learning rate to the base LR decayed by 10 every step epochs"""
    lr_schedule = lambda t: np.interp([t], [20, 40], [base_lr, base_lr*0.1])[0]
    lr = lr_schedule(epoch + (i*n_repeats + j + 1)*1.0/max_iter)
